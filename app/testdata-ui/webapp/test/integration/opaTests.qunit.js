...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "gisa/testdata/testdataui/test/integration/FirstJourney",
    "gisa/testdata/testdataui/test/integration/GeneratorDataListJourney",
    "gisa/testdata/testdataui/test/integration/GeneratorDataObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
